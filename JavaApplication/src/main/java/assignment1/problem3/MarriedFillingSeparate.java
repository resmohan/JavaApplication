...
/**
 * Represents the group filer instance who are married and filing the taxes separately
 */
public class MarriedFillingSeparate extends GroupFiler{
   ...
   */
  public MarriedFillingSeparate(ContactInfo contactInfo, double lastYearEarnings,
  ...
  /**
   * Generates the string representation of married filling separate
   * @return string representation of married filling separate
   */
  @Override
  public String toString() {
    return "MarriedFillingSeparate{}";
  }
}
