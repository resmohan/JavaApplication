...
/**
 * Represents the group filer instance who are married and filing taxes jointly
 */
public class MarriedFillingJoint extends GroupFiler{
   ...
   */
  public MarriedFillingJoint(ContactInfo contactInfo, double lastYearEarnings, double incomeTaxPaid,
  ...
  /**
   * Generates the string representation of married filling jointly
   * @return string representation of married filling jointly
   */
  @Override
  public String toString() {
    return "MarriedFillingJoint{}";
  }
}
